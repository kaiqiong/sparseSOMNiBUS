...
see1 = fitProxGradCpp( theta=theta, stepSize=stepSize,lambda1=lambda1,
                                   dat=dat, basisMat0= basisMat0, nk=n.k, 
                                   sparOmega= sparOmega, lambda2=lambda2, 
                                   smoOmega1=smoOmega1,
                                   maxInt = maxInt, epsilon = epsilon, printDetail = printDetail,shrinkScale=shrinkScale,
                                   accelrt=accelrt, numCovs=numCovs, designMat1= designMat1, basisMat1=basisMat1,
                       binomObject, thetaUpdate, twoPenalties )


see2=oneUpdate(theta, stepSize=stepSize, lambda1, dat, basisMat0, n.k, Hp, numCovs,
...
see = microbenchmark(R = {
  oneUpdate(theta, stepSize=stepSize, lambda1, dat, basisMat0, n.k, Hp, numCovs,
            shrinkScale,designMat1, theta_m, iter, accelrt)
},
                     cpp =fitProxGradCpp( theta=theta, stepSize=stepSize,lambda1=lambda1,
                                          dat=dat, basisMat0= basisMat0, nk=n.k, 
                                          sparOmega= sparOmega, lambda2=lambda2, 
                                          smoOmega1=smoOmega1,
                                          maxInt = maxInt, epsilon = epsilon, printDetail = printDetail,shrinkScale=shrinkScale,
